...
interface InterconsultasViewerProps {
  onPatientUpdated?: () => void;
}

export default function InterconsultasViewer({
  onPatientUpdated,
}: InterconsultasViewerProps) {
  ...
  async function loadPatients() {
    setLoading(true);
    setError(null);
    const { data, error: fetchError } = await getPatientsByDestination('interconsulta');
    if (fetchError) {
