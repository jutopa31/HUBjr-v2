...
import EvolucionadorV3 from './components/EvolucionadorV3';
...
const NeurologyResidencyHub = () => {
  ...
  // Estado para interconsulta activa (workflow integration - pendiente migración v3)
  const [_activeInterconsulta, setActiveInterconsulta] = useState<any | null>(null);

  // Estado para paciente post-alta activo (workflow integration - pendiente migración v3)
  const [_activePostAltaPatient, setActivePostAltaPatient] = useState<any | null>(null);
  ...
  // Callbacks y lógica (notas legacy - ahora en patients_v3)
  // copyNotes y clearNotes removidos - funcionalidad integrada en EvolucionadorV3
  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'diagnostic':
        return (
          <EvolucionadorV3 hospitalContext={currentHospitalContext} />
        );
      case 'inicio':
